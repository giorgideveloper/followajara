	...
	.shape(
		{
			...
			fb: yup.string().when(['ig', 'yt', 'tk'], {
				is: (ig: string, yt: string, tk: string) => !ig && !yt && !tk,
				then: () =>
					yup.string().required('* მიუთითეთ მინიმუმ ერთი სოციალური ქსელი.'),
			}),
			ig: yup.string().when(['fb', 'yt', 'tk'], {
				is: (fb: string, yt: string, tk: string) => !fb && !yt && !tk,
				then: () =>
					yup.string().required('* მიუთითეთ მინიმუმ ერთი სოციალური ქსელი.'),
			}),
			yt: yup.string().when(['fb', 'ig', 'tk'], {
				is: (fb: string, ig: string, tk: string) => !fb && !ig && !tk,
				then: () =>
					yup.string().required('* მიუთითეთ მინიმუმ ერთი სოციალური ქსელი.'),
			}),
			tk: yup.string().when(['fb', 'ig', 'yt'], {
...
const ObjRegisterForm: FC<RegisterFormProps> = () => {
